...
const articleSchema = {
  ...
  '@type': 'Article',
  headline: 'Top 5 Cybersecurity Mistakes Small Australian Businesses Make',
  author: { '@type': 'Organization', name: 'IntrusionX' },
  publisher: { '@type': 'Organization', name: 'IntrusionX', url: 'https://intrusionx.com.au' },
  datePublished: '2025-02-01',
  dateModified: '2025-02-01',
  description: 'Discover the most common cybersecurity mistakes that put small Australian businesses at risk.',
  url: 'https://intrusionx.com.au/blog/cybersecurity-mistakes-small-businesses',
};
...
const breadcrumbSchema = {
  ...
  '@type': 'BreadcrumbList',
  itemListElement: [
    { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://intrusionx.com.au' },
    { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://intrusionx.com.au/blog' },
    { '@type': 'ListItem', position: 3, name: 'Top 5 Cybersecurity Mistakes Australian SMBs Make', item: 'https://intrusionx.com.au/blog/cybersecurity-mistakes-small-businesses' },
  ],
};
