...
const articleSchema = {
  ...
  url: 'https://intrusionx.com.au/blog/how-ransomware-attacks-work',
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'How Ransomware Attacks Work — And How to Stop Them', item: 'https://intrusionx.com.au/blog/how-ransomware-attacks-work' },
  ],
};
